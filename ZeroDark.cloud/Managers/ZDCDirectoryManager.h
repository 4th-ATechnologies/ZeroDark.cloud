...
/**
 * The ZeroDarkCloud framework attempts to keep all stored files within a few "zdc" folders.
 * This method returns the top-level container that stores all database files.
 *
...
/**
 * The ZeroDarkCloud framework attempts to keep all stored files within a few "zdc" folders.
 * This method returns the top-level container for persistent data files
...
/**
 * The ZeroDarkCloud framework attempts to keep all stored files within a few "zdc" folders.
 * This method returns the top-level container for temporary cached data files
 * stored by the ZeroDarkCloud instance using the given databaseName.
 *
